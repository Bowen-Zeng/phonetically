      ...
      <nav className="landing-nav">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <img 
              src="/public/phoneticallylogo.png"
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 relative overflow-hidden">
        ...
        <div className="content-wrapper text-center relative z-10">
          ...
          <p className="hero-subtitle mb-12">
            Phonetically is an accessible pronunciation coach for Deaf and Hard of Hearing users
             and language learners to help them speak with confidence.
          </p>
    ...
    <div className="flex-1 flex flex-col items-center justify-center p-6">
      <div className="content-wrapper">
        ...
        <p className="text-white/70 text-center max-w-lg mb-12 text-lg">
          Pronunciation practice, designed for accessibility.
        </p>
